...
geog_alloc_fractions %>%
  gt() %>%
  tab_header(
    title = "Table X. Fractional Allocations to Geographic Levels for DDP and v20200527"
  ) %>%
  cols_label(
...
For the DDP and v20200527, the PLB was 4.0, the geographic level fractions are listed in Table X, and the query fractions are shown in the _Allocation_ column of Table X.
...
query_allocs_wide %>%
  gt(groupname_col = "vintage",
     rowname_col = "query") %>%
  tab_header(
    title = "Table X. Fractional Allocations, Scale Factors, and Standard Deviations for Queries",
