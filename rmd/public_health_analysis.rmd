...
Public health scientists and practitioners rely on decennial census data on the sex, age, race, and Hispanic ethnicity for states, counties, cities, and neighborhoods to track a wide range of health outcomes. Decennial data provide crucial denominators when XXXXX. 
...
Results of this attack pushed the Bureau to develop and implement new disclosure avoidance techniques that XXXXX. 
